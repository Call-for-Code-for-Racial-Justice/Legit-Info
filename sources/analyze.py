#!/usr/bin/env python3
# analyze.py -- List txt files in COS
# By Shilpi Bhattacharyya and Tony Pearson, IBM, 2020
# requires that you do:  pip install -U ibm-cos-sdk ibm-watson
#
import os
import sys
import glob
...
def returnImpactAreaFromBill(text):    
...
def process_legislation(cos, bucket_name, key, size):
    ...
    relevant_words = returnImpactAreaFromBill(extracted_text)    
